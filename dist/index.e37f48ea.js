...
const showRecipeController = async ()=>{
    try {
        ...
        if (!id) throw new Error("Chưa c\xf3 kết quả !!!!!!!");
        // update results view to mark selected search result
        const recipes = (0, _modelDefault.default).recipePage(1);
        (0, _resultsViewDefault.default).update(recipes);
        // ----------------------------------
        await (0, _modelDefault.default).loadRecipe(id);
        if ((0, _modelDefault.default).data.bookMarks.some((el)=>el.id === (0, _modelDefault.default).data.recipe.id)) (0, _modelDefault.default).data.recipe.bookMarked = true;
        else (0, _modelDefault.default).data.recipe.bookMarked = false;
        const recipe = (0, _modelDefault.default).data.recipe;
...
const searchController = async ()=>{
    try {
        const query = (0, _searchViewDefault.default).renderSearch();
        if (!query) return;
        (0, _resultsViewDefault.default).renderSpinner();
        await (0, _modelDefault.default).searchRecipe(query);
        const results = (0, _modelDefault.default).data.results;
        const recipes = (0, _modelDefault.default).recipePage(1);
        (0, _resultsViewDefault.default).render(recipes);
        (0, _paginationViewDefault.default).render({
            currentPage: 1,
            results
        });
    } catch (e) {
...
const paginationController = (goToPage)=>{
    const recipes = (0, _modelDefault.default).recipePage(goToPage);
    (0, _resultsViewDefault.default).render(recipes);
    (0, _paginationViewDefault.default).render({
        currentPage: goToPage,
        results: (0, _modelDefault.default).data.results
    });
};
const updateServingsController = (newServings)=>{
    (0, _modelDefault.default).updateServings(newServings);
    // RecipeView.render(State.data.recipe)
    (0, _recipeViewDefault.default).update((0, _modelDefault.default).data.recipe);
};
const bookmark = ()=>{
    if (!(0, _modelDefault.default).data.recipe.bookMarked) (0, _modelDefault.default).addBookMark((0, _modelDefault.default).data.recipe);
    else (0, _modelDefault.default).deletBookMark((0, _modelDefault.default).data.recipe.id);
    (0, _bookMarksViewDefault.default).render((0, _modelDefault.default).data.bookMarks);
    (0, _recipeViewDefault.default).update((0, _modelDefault.default).data.recipe);
};
const init = ()=>{
    (0, _recipeViewDefault.default).addHandlerRender(showRecipeController);
    (0, _recipeViewDefault.default).addHandlerUpdateRecipe(updateServingsController);
    (0, _recipeViewDefault.default).addHandlerBookMark(bookmark);
    (0, _searchViewDefault.default).addHandlerRender(searchController);
    (0, _paginationViewDefault.default).addHandlerClick(paginationController);
};
init();

},{"./model":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/recipeView":"7Olh7","./view/searchView":"blwqv","./view/resultsView":"46Nfk","./view/paginationView":"9Reww","./view/bookMarksView":"5beaC"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class State {
    ...
    async loadRecipe(id) {
        try {
            const data = await Promise.race([
                _helpers.callApi(`${(0, _config.API_URL)}${id}`),
                _helpers.timeOut((0, _config.TIME_OVER))
            ]);
    ...
    async searchRecipe(query) {
        try {
            const data = await _helpers.callApi(`${(0, _config.API_URL)}?search=${query}`);
            if (!data || data.data.recipes.length === 0) throw new Error("Kh\xf4ng c\xf3 dữ liệu");
    ...
    recipePage(page) {
        const start = (page - 1) * (0, _config.RECIPE_OF_PAGE);
        const end = page * (0, _config.RECIPE_OF_PAGE);
...
parcelHelpers.export(exports, "TIME_OVER", ()=>TIME_OVER);
parcelHelpers.export(exports, "RECIPE_OF_PAGE", ()=>RECIPE_OF_PAGE);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes/";
const TIME_OVER = 10;
const RECIPE_OF_PAGE = 10;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hGI1E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "timeOut", ()=>timeOut);
parcelHelpers.export(exports, "callApi", ()=>callApi);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "Sản phẩm bạn t\xecm kh\xf4ng tồn tại, h\xe3y thử sản phẩm kh\xe1c !!!";
    ...
    addHandlerRender(callback) {
        [
            "load",
            "hashchange"
        ].forEach((even)=>window.addEventListener(even, callback));
    }
...
class ResultView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "Kh\xf4ng c\xf3 kết quả t\xecm kiếm !!!!!!!!!!";
...
},{"./View":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Reww":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup(data) {
        ...
        const pages = Math.ceil(results.length / (0, _config.RECIPE_OF_PAGE));
        if (currentPage === 1 && currentPage < pages) return `
            ...
            `;
        else if (currentPage > 1 && currentPage < pages) return `
            ...
            `;
        else if (currentPage === pages) return `
            <button goToPage="${currentPage - 1}" class="btn--inline pagination__btn--prev">
                <svg class="search__icon">
                    <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
                </svg>
...
},{"./View":"gAkKI","url:../../img/icons.svg":"loVOp","../config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5beaC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class BookMarksView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "Kh\xf4ng c\xf3 kết quả !!!!!!!!!!";
    _generateMarkup(results) {
        const id = window.location.hash.slice(1);
        return results.map((recipe)=>{
            return `
...
},{"./View":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire7e89")
